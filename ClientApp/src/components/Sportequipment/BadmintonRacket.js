...
const BadmintonRacket = () => {
    return (
        <div>
            <Container className='flex justify-center my-12'>
                <h1 className='m-4 font-bold text-title text-4xl z-50'>Bán chạy</h1>
                        ...
                        <Card >
                            <CardActionArea>
                                <CardMedia
                                    component="img"
                                    height="140"
                                    image="https://m.media-amazon.com/images/I/71as+TTcTdL._AC_UL480_FMwebp_QL65_.jpg"
                                    alt="green iguana"
                                    sx={{ boxShadow: 15 }}
...
export default BadmintonRacket